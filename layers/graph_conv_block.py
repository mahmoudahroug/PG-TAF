...
class Graph_Conv_Block(nn.Module):
    def __init__(self, input_dim, output_dim, dropout=0.5, residual=True):
        ...
        self.gcn1 = GCNLayer(input_dim, output_dim, activation='leakyrelu', residual=residual)
        self.gcn2 = GCNLayer(output_dim, output_dim, activation='leakyrelu', residual=residual)
